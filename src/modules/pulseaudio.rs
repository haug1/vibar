...
use self::config::{
    ...
    DEFAULT_FORMAT_SOURCE, DEFAULT_FORMAT_SOURCE_MUTED, ICON_CAR, ICON_HANDS_FREE, ICON_HEADPHONE,
    ICON_HEADSET, ICON_PHONE, ICON_PORTABLE, ICON_VOLUME_HIGH, ICON_VOLUME_LOW, ICON_VOLUME_MEDIUM,
};
