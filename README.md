...
- Playerctl module with event-driven MPRIS metadata/status, optional idle auto-hide, and optional left-click controls popover (transport, seek, and progress timestamps)
